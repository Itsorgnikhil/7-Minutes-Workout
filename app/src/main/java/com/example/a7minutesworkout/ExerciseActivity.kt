...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private var restTimerDuration: Long = 10  // Set to 10 seconds

    private var exerciseTimer: CountDownTimer? = null
    private var exerciseProgress: Int = 0
    private var exerciseTimerDuration: Long = 30  // Set to 30 seconds
    ...
    private fun setExerciseProgressBar() {
        binding?.progressBarExercise?.max = exerciseTimerDuration.toInt()
        exerciseProgress = 0
            ...
            override fun onFinish() {
                ...
                if (currentExercisePosition < exerciseList!!.size - 1) {
                    ...
                    lifecycleScope.launch {
                        dao.insert(HistoryEntity(currentDate))
                    }
